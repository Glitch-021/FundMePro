  ...
  return (
    <div className="bg-[#1c1c24] flex justify-center items-center flex-col rounded-[10px] sm:p-10 p-4">
      ...
      <div className="flex justify-center items-center p-[16px] sm:min-w-[380px] bg-[#3a3a43] rounded-[10px]">
        <h1 className="font-nunito font-bold sm:text-[25px] text-[18px] leading-[38px] text-white">
          Start a Campagin
        </h1>
      </div>
      ...
      >
        ...
        <div className="w-full flex justify-start items-center p-4 bg-[#8c6dfd] h-[120px] rounded-[10px]">
          <img
            src="https://img.icons8.com/?size=100&id=42326&format=png&color=000000"
            alt="money"
            className="w-[40px] h-[40px] object-contain filter invert "
          />
          <h4 className="font-nunito font-hubot text-[25px] text-white ml-[25px]">
